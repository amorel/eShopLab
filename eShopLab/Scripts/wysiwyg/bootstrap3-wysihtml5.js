!function($, wysi) {
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: [unescape(window.location.protocol + "//" + window.location.host + "/Scripts/wysiwyg/bootstrap3-wysiwyg5-color.css")], // (path_to_project/lib/css/bootstrap3-wysiwyg5-color.css)
        locale: "en"
    };
