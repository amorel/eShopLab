...
namespace eShopLab.Areas.Admin.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            var products = db.Products.Include(p => p.Category).Include(p => p.Medium).Include(p => p.UnitType).Include(p => p.VATCategory);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.VATCategoryID = new SelectList(db.VATCategories, "VATCategoryID", "VATCategoryName");
            return View();
        }
        ...
        public ActionResult Create(Product product)
        {
            ...
            ViewBag.VATCategoryID = new SelectList(db.VATCategories, "VATCategoryID", "VATCategoryName", product.VATCategoryID);
            return View(product);
        }
